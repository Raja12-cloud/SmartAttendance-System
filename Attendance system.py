...
path = "profile.jpg"
message = tk.Label(window, text="Face detection system" ,bg="Black"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold')) 

message.place(x=200, y=20)

lbl = tk.Label(window, text="Your ID",width=20  ,height=2  ,fg="red"  ,bg="white" ,font=('times', 15, ' bold ') ) 
lbl.place(x=400, y=200)

txt = tk.Entry(window,width=20  ,bg="white" ,fg="red",font=('times', 15, ' bold '))
txt.place(x=700, y=215)

lbl2 = tk.Label(window, text="Your Name",width=20  ,fg="red"  ,bg="white"    ,height=2 ,font=('times', 15, ' bold ')) 
lbl2.place(x=400, y=300)

txt2 = tk.Entry(window,width=20  ,bg="white"  ,fg="red",font=('times', 15, ' bold ')  )
txt2.place(x=700, y=315)

lbl3 = tk.Label(window, text="Update : ",width=20  ,fg="red"  ,bg="white"  ,height=2 ,font=('times', 15, ' bold ')) 
lbl3.place(x=400, y=400)

message = tk.Label(window, text="" ,bg="white"  ,fg="red"  ,width=30  ,height=2, activebackground = "white" ,font=('times', 15, ' bold ')) 
message.place(x=700, y=400)

lbl3 = tk.Label(window, text="Attendance : ",width=20  ,fg="red"  ,bg="white"  ,height=2 ,font=('times', 15, ' bold ')) 
...
quitWindow = tk.Button(window, text="Exit", command=window.destroy  ,fg="Black"  ,bg="white"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
quitWindow.place(x=1100, y=500)
copyWrite = tk.Text(window, background=window.cget("background"), borderwidth=0,font=('times', 30, 'italic bold'))
copyWrite.tag_configure("superscript", offset=10)
copyWrite.insert("insert", "FUSION")
